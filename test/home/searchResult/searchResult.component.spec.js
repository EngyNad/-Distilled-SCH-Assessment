describe('The search result component', function () {
    'use strict';
    ...
    beforeEach(function () {
        ...
        inject(function ($injector) {
            ...
            searchResultComponent = $componentController('searchResult', null, {
                beer: beer
            });
    ...
    it('should initialize with brewery', function () {
        expect(searchResultComponent).toBeDefined();
        expect(searchResultComponent.beer).toEqual(beer);
    });
